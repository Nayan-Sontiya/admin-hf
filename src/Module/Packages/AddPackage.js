                                        ...
                                        <div className='row d-flex justify-content-center mt-4 mb-5'>
                                            <div className='col-7'>
                                                <div className="form-group row mt-4">
                                                    <label className="col-sm-3 col-form-label text-dark text-md-right"><h6>Package Name</h6></label>
                                                ...
                                                <div className="form-group row mt-4">
                                                    <label className="col-sm-3 col-form-label text-dark text-md-right"><h6>Number of Resume</h6></label>
                                                    <div className="col-sm-7">
                                                ...
                                                <div className="form-group row mt-4">
                                                    <label className="col-sm-3 col-form-label text-dark text-md-right"><h6>Package Price</h6></label>
                                                    <div className="col-sm-7">
                                                        <input type="number" className="form-control"
                                                ...
                                                <div className="form-group row mt-4">
                                                    <label className="col-sm-3 col-form-label text-dark text-md-right"><h6>Validity</h6></label>
                                                    <div className="col-sm-7">
                                                        <input type="number" className="form-control"
