...
const Registration = () => {
  ...
  console.log("getCandidateInfo", data);
  ...
  useEffect(() => {
    if (data !== undefined) {
      setName_of_candidate(data.name_of_candidate);
      ...
      setRelative_contact_no(data.relative_contact_no);
      setDob(data.dob);
      setGender(data.gender);
      setMarital_status(data.marital_status);
      setReligion(data.religion);
      setEducation(data.education);
      setAdditionalEducation(data.additionalEducation);
      setAadhar_card_no(data.aadhar_card_no);
      setPan_card_no(data.pan_card_no);
      setHobbies_and_interest(data.hobbies_and_interest);
      setLanguages(data.languages);
      setType_of_employement(data.type_of_employement);
      setObjective(data.objective);
      setCategory(data.category);
      setExperiences(data.experiences);
      setProfilePreview(data.photo_of_candidate);
    }
  }, [data]);
  ...
  useEffect(() => {
    ...
    setExpInMonth(expDetailsData.expInMonth);
  ...
  const submitExp = (e) => {
    ...
    // experiencesDetails.id = (Math.floor(Math.random() * 10000) + 10000)
    //   .toString()
    //   .substring(1);
    ...
    experiencesDetails.expInMonth = expInMonth;
    experiencesDetails.singleMonth = singleMonth;
  ...
  function monthDiff(date1, date2) {
    ...
    } else if (expInMonth !== undefined || expInMonth !== "") {
      let expInMonths = parseInt(expInMonth);
      console.log("----expInMonths", expInMonths);
      setExperience((prev) => prev + expInMonths);
    } else {
      let n = 0;
      console.log("kkk");
  ...
  async function registration() {
    ...
    // data.append("place_of_issue", place_of_issue);
    ...
    // if (dishPhotograph.length !== 0) {
    //   [...dishPhotograph].forEach((DishPhotograph) => {
    //     data.append("dish", DishPhotograph);
    //   });
    // }
  ...
  const validateIfFieldEmpty = () => {
    if (
      ...
      if (aadhar_card_no === "") {
        document.getElementById("aadharCard").style.border = "1px solid red";
      }
      if (pan_card_no === "") {
        document.getElementById("panCard").style.border = "1px solid red";
      }
      if (email_address === "") {
        document.getElementById("email").style.border = "1px solid red";
      }
                            ...
                            <div className="form-group row mt-4">
                              ...
                              <div className="col-sm-7">
                                ...
                                <span className="text-info small">
                                  If you are a chef/cook please add images of
                                  your dishes
                                </span>
                                <div id="preview">
